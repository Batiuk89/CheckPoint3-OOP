    ...
    public String compare() {
        ...
        if (age >= 1 && age <= 2){
            if ((sleep >= 11) && (sleep <= 14)) {
                return message = "Congratulations! According to your age, you're sleeping enough hours.";
            } else if (sleep < 11) {
                ...
                return message = "Hey, sleepy head. You're sleeping more than enough. \nAccording to your age, you should be sleeping between 8 and 10 hours per night.";
            }
        } 
        ...
        //Adults (26–64 years): 7–9 hours
            ...
            if((sleep >= 7) && (sleep <= 9)){
                ...
                return message = "That's bad. You're not sleeping enough hours. \nAccording to your age, you should be sleeping between 7 and 9 hours per night.";
            } else if (sleep > 9) {
                return message = "Hey, sleepy head. You're sleeping more than enough. \nAccording to your age, you should be sleeping between 7 and 9 hours per night.";
            }
        }
        ...
        //Older adults (65+ years): 7–8 hours
            ...
            if((sleep >= 7) && (sleep <= 8)){
                ...
                return message = "That's bad. You're not sleeping enough hours. \nAccording to your age, you should be sleeping between 7 and 8 hours per night.";
            } else if (sleep > 8) {
                return message = "Hey, sleepy head. You're sleeping more than enough. \nAccording to your age, you should be sleeping between 7 and 8 hours per night.";
            }
        }
